...
function FileUploadDownload() {
    ...
    const downloadFile = () => {
        ...
        const randomNumber = Math.random(); // Generate a random number for file naming
        saveAs(new Blob([response], { type: 'application/pdf' }), `${parseInt(randomNumber)}-downloaded.pdf`);
